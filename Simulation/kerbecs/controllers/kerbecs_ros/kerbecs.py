    ...
    def walk(self):
        ...
        while(True):
            ...
            for leg_id in range(4):
                self.compute_walking_position(motor_positions, (self.step_count * (SIMULATION_STEP_DURATION / 1000.0)), frequency, gait_type, leg_id, stride_length_factor[leg_id], backwards)
